		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getDeclarationAccess().getGroup_24(), "rule__Declaration__Group_24__0");
					...
					put(grammarAccess.getDeclarationAccess().getTopicsAssignment_6(), "rule__Declaration__TopicsAssignment_6");
					put(grammarAccess.getDeclarationAccess().getTopicsAssignment_7(), "rule__Declaration__TopicsAssignment_7");
					put(grammarAccess.getDeclarationAccess().getDateAssignment_9_1(), "rule__Declaration__DateAssignment_9_1");
					put(grammarAccess.getDeclarationAccess().getLocationAssignment_10_1(), "rule__Declaration__LocationAssignment_10_1");
					put(grammarAccess.getDeclarationAccess().getPriceAssignment_12(), "rule__Declaration__PriceAssignment_12");
					put(grammarAccess.getDeclarationAccess().getVolumeAssignment_13_1(), "rule__Declaration__VolumeAssignment_13_1");
					...
					put(grammarAccess.getDeclarationAccess().getArticle_imagesAssignment_24_1(), "rule__Declaration__Article_imagesAssignment_24_1");
					put(grammarAccess.getDeclarationAccess().getColumns_cntAssignment_26(), "rule__Declaration__Columns_cntAssignment_26");
					put(grammarAccess.getDeclarationAccess().getFont_sizeAssignment_28(), "rule__Declaration__Font_sizeAssignment_28");
