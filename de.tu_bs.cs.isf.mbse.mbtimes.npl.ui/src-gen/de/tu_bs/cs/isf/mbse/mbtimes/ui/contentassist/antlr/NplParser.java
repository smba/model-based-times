		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getDeclarationAccess().getRecrawlAssignment_1_0(), "rule__Declaration__RecrawlAssignment_1_0");
					put(grammarAccess.getDeclarationAccess().getFeedlinksAssignment_1_3(), "rule__Declaration__FeedlinksAssignment_1_3");
