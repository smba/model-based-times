 ...
 * </p>
 * <ul>
 *   <li>{@link de.tu_bs.cs.isf.mbse.mbtimes.npl.impl.CurrencyImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CurrencyImpl extends MinimalEObjectImpl.Container implements Currency
{
  ...
  {
    return NplPackage.Literals.CURRENCY;
  }
  ...
  public void setValue(String newValue)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, NplPackage.CURRENCY__VALUE, oldValue, value));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case NplPackage.CURRENCY__VALUE:
        return getValue();
    }
