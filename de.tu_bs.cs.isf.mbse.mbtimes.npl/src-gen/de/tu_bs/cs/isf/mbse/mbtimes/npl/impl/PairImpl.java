...
public class PairImpl extends MinimalEObjectImpl.Container implements Pair
{
  ...
  {
    return NplPackage.Literals.PAIR;
  }
  ...
  public void setKey(String newKey)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, NplPackage.PAIR__KEY, oldKey, key));
  }
  ...
  public void setValue(String newValue)
  {
    ...
    value = newValue;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, NplPackage.PAIR__VALUE, oldValue, value));
  }
